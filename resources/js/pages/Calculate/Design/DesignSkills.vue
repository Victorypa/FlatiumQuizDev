            ...
            <div class="image-wrapper">
              <div class="image-card fade-in one">
                  <button class="button-card active">
                    ...
                    <div class="image-text">Эксперт</div>
                    <div class="image-subtitle">
                      Я хорошо разбираюсь в стилях и могу помочь дизайнеру найти идеальные вещи.
                    </div>
                  </button>
              </div>
              ...
              <div class="image-card fade-in two">
                  <button class="button-card">
                    ...
                    <div class="image-text">Кое-что понимаю.</div>
                <div class="image-subtitle">
                  Я примерно знаю, что мне нравится. Но мне хочется экспертного мнения и идей.
                </div>
                  </button>
              </div>
              ...
              <div class="image-card fade-in three">
                  <button class="button-card">
                    ...
                    <div class="image-text">Совсем не разбираюсь</div>
                    <div class="image-subtitle">
